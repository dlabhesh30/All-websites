...
<div class="container" >
  <div class="row">
   <div class="col-md-6">
   	...
   	<img src="img/8.jpg" alt="Image not available" class="image-responsive"/>

   </div>
   <div class="col-md-6">
    <h2>Robot Golf Cart</h2>
    <p>
    	<dl>
    		<dd>Helps in traversing wide fields</dd>
    		<dd>Disk breaks for a quick stop</dd>
    		<dd>Can handle upto 250lbs</dd>
