       ...
       <div class="main">
       	...
       	<div class="mens-toolbar">
              <div class="sort">
               	<div class="sort-by">
		            <label>Sort By : </label>
		             <inline> &nbsp;&nbsp;&nbsp;<a href="myhelpinghandonline.com/272/labheshviews.php">MostVisited</a>
		             &nbsp;&nbsp;&nbsp;<a href="myhelpinghandonline.com/272/labheshratings.php">Ratings </a>
		              &nbsp;&nbsp;&nbsp;<a href="myhelpinghandonline.com/272/labheshproducts.php">Popularity</a>&nbsp;&nbsp;&nbsp;<a href="cookies.php">Recently Visited</a></inline>	        
               </div>
    		  </div>	         
     	    <div class="clear"></div>
	       </div>    
         <div class="content-bottom">
			...
			curl_setopt($ch, CURLOPT_URL, "http://labheshdeshpande.com/orderbyratings.php");
