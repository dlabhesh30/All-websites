				  ...
				  <article style="position: relative; width: 100%; opacity: 1;"> 
				   	<div class="banner-wrap">
						 ...
						 <div class="slider-right">
						    <h1>Amazing</h1>
						    <h2>Guitars</h2>
						    <p>We have the best collection of guitars here</p>
						    <div class="btn"><a href="labheshproducts.php">Shop Now</a></div>
						 </div>
						 <div class="clear"></div>
					 </div>
					</article>
				   <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	 <div class="banner-wrap">
					   	<div class="slider-left">
							<img src="images/sidharth.jpg" alt=""/> 
						</div>
						 <div class="slider-right">
						    <h1>Smart</h1>
						    <h2>Robots</h2>
						    <p>Future is here</p>
						    <div class="btn"><a href="sidharthproducts.php">Shop Now</a></div>
						 </div>
						 <div class="clear"></div>
					 </div>
				   </article>
				   <article style="position: absolute; width: 100%; opacity: 0;">
				   	<div class="banner-wrap">
					   	<div class="slider-left">
							<img src="images/gurnoor.jpg" alt=""/> 
						</div>
						 <div class="slider-right">
						    <h1>Diagon Alley</h1>						    
						    <p> Product from shadow lands beyond asshai</p>
						    <div class="btn"><a href="gurnoorproducts.php">Shop Now</a></div>
						 </div>
						 <div class="clear"></div>
					 </div>
				   </article>
				   <article style="position: absolute; width: 100%; opacity: 0;">
				   	<div class="banner-wrap">
					   	<div class="slider-left">
							<img src="images/viraj.png" alt=""/> 
						</div>
						 <div class="slider-right">
						    <h1>Almost</h1>
						    <h2>everything</h2>
						    <p>We sell almost everything, second hand products also there</p>
						    <div class="btn"><a href="virajproducts.php">Shop Now</a></div>
						 </div>
						 <div class="clear"></div>
					 </div>
				   </article>
				   <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	 <div class="banner-wrap">
						 ...
						 <div class="slider-right">
						    <h1>Beautiful </h1>
						    <h2>cars</h2>
						    <p>We have the best cars here</p>
						    <div class="btn"><a href="arunproducts.php">Shop Now</a></div>
						 </div>
						 <div class="clear"></div>
					 </div>
			      </article>
				   ...
				   <div class="box1">
				    <?php 
							...
							<?php 
								...
								curl_setopt($ch, CURLOPT_URL, "http://myhelpinghandonline.co/getOne.php");
