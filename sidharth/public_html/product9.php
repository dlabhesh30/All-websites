...
<div class="container" >
  <div class="row">
   <div class="col-md-6">
   	...
   	<img src="img/9.jpg" alt="Image not available" class="image-responsive"/>

   </div>
   <div class="col-md-6">
    <h2>Robot Lawn Mower</h2>
    <p>
    	<dl>
    		<dd>Can mow even small grass</dd>
    		<dd>Can work on wet grass</dd>
    		<dd>Has a bucket to store mowed grass</dd>
    		<dd>60000mAh Battery</dd>
    		<dd>Price: $899</dd>
