...
<div class="container" >
  <div class="row">
   <div class="col-md-6">
   	...
   	<img src="img/3.jpg" alt="Image not available" class="image-responsive"/>

   </div>
   <div class="col-md-6">
    <h2>Robot Army Man</h2>
    <p>
    	<dl>
    		<dd>Four legged robot</dd>
    		<dd>Can carry heavy bags</dd>
    		<dd>Runs at 24 miles per hour</dd>
    		<dd>100000mAh Battery</dd>
    		<dd>Price: $1499</dd>
