...
<link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css"
 ...
 crossorigin="anonymous">
		...
		<title>Robot Delivery Boy</title>
	</head>
...
<div class="container" >
  <div class="row">
   <div class="col-md-6">
   	...
   	<img src="img/10.jpg" alt="Image not available"/>

   </div>
   <div class="col-md-6">
    <h2>Robot Delivery Boy</h2>
    <p>
    	<dl>
    		<dd>Helps to deliver packages within building</dd>
    		<dd>Can fetch simple tasks</dd>
    		<dd>Can store transactions for a later review</dd>
