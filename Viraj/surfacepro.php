...
<article><section>
<img src="./images/surfacepro.jpg" height="300" width="400">
<?php
print("<h1><a href='services.html'>BACK</a></h1>");
  if(isset($_COOKIE["surfacepro"])){
    $val=$_COOKIE["surfacepro"]+1;
    print("new value is $val");
    setcookie("surfacepro",$val);
  }else{
    print("Setting cookie in count");
    setcookie("surfacepro",1);
  }
  for ($i=1; $i <=5 ; $i++) { 
    if (!isset($_COOKIE[$i])){
      setcookie($i,"surfacepro");
