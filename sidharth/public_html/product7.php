...
<div class="container" >
  <div class="row">
   <div class="col-md-6">
   	...
   	<img src="img/7.jpg" alt="Image not available" class="image-responsive"/>

   </div>
   <div class="col-md-6">
    <h2>Robot Pet Feeder</h2>
    <p>
    	<dl>
    		<dd>Feeds pet any number of times per day</dd>
    		<dd>Can feed different pets</dd>
    		<dd>Can be set to server different meals</dd>
    		<dd>30000mAh Battery</dd>
    		<dd>Price $499</dd>
