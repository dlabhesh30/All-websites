...
<article><section>
<img src="./images/surfacelaptop.jpg" height="300" width="400">
<?php
print("<h1><a href='services.html'>BACK</a></h1>");
  if(isset($_COOKIE["surfacelaptop"])){
    $val=$_COOKIE["surfacelaptop"]+1;
    print("new value is $val");
    setcookie("surfacelaptop",$val);
  }else{
    print("Setting cookie in count");
    setcookie("surfacelaptop",1);
  }
  for ($i=1; $i <=5 ; $i++) { 
    if (!isset($_COOKIE[$i])){
      setcookie($i,"surfacelaptop");
