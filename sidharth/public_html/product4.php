...
<link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css"
 ...
 crossorigin="anonymous">
		...
		<title>Robot Professional X1</title>
	</head>
...
<div class="container" >
  <div class="row">
   <div class="col-md-6">
   	...
   	<img src="img/4.jpg" alt="Image not available" class="image-responsive"/>

   </div>
   <div class="col-md-6">
    <h2>Robot Professional X1</h2>
    <p>
    	<dl>
    		<dd>Designed for professional environment</dd>
    		<dd>Can escort clients within a building</dd>
    		<dd>Can move files among employees</dd>
